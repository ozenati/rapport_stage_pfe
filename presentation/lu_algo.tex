...
\onslide*<4>{Task to update other panel tiles: TRSM\_L}
\onslide*<5>{Task to update eliminated rows tiles: TRSM\_U}
\onslide*<6>{Task to update trailing sub-matrix: GEMM}
\end{flushleft}
\end{frame}
